...
// -----------------------------------------------------------------
    ...
    public double darTiempoPromedio() {
        ...
        if (cantidadCarros > 0) {
            double promedio = (double) totalTiempo / cantidadCarros;
            return promedio;
        } else {
            return 0;
        }
    ...
    public Carro darCarroMasHoras() {
        ...
        for (Puesto puesto : puestos) {
            if (puesto.estaOcupado()) {
                Carro carro = puesto.darCarro();
                int horasParqueadero = carro.darTiempoEnParqueadero(horaActual);

                if (horasParqueadero > maxHoras) {
                    maxHoras = horasParqueadero;
                    carroMasHoras = carro;
                }
            }
        }
    ...
    public ArrayList<Carro> darCarrosMasDeTresHorasParqueados() {
        ArrayList<Carro> carrosMasTresHoras = new ArrayList<>();
        ...
        for (Puesto puesto : puestos) {
            if (puesto.estaOcupado()) {
                ...
                if (horasParqueadero > 3) {
                    carrosMasTresHoras.add(carro);
                }
            }
        }

        return carrosMasTresHoras;
    }
    ...
    public String metodo1() {
        int carrosConPlacaPB = contarCarrosQueComienzanConPlacaPB();
        boolean hayCarro24Horas = hayCarroCon24Horas();
        String mensaje = "Cantidad de carros con placa PB: " + carrosConPlacaPB + " - Hay carro parqueado por 24 o más horas: ";
    ...
    public String metodo2() {
        ...
        String mensaje = "Cantidad de carros sacados: " + carrosSacados + ".";
